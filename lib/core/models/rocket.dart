class Rocket {
  ...
  Rocket.fromJson(Map<String, dynamic> json) {
    height = json['height'] != null ? new Height.fromJson(json['height']) : null;
    diameter = json['diameter'] != null ? new Diameter.fromJson(json['diameter']) : null;
    mass = json['mass'] != null ? new Mass.fromJson(json['mass']) : null;
    firstStage = json['first_stage'] != null ? new FirstStage.fromJson(json['first_stage']) : null;
    secondStage = json['second_stage'] != null ? new SecondStage.fromJson(json['second_stage']) : null;
    engines = json['engines'] != null ? new Engines.fromJson(json['engines']) : null;
    landingLegs = json['landing_legs'] != null ? new LandingLegs.fromJson(json['landing_legs']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.payloadWeights != null) {
      data['payload_weights'] = this.payloadWeights.map((v) => v.toJson()).toList();
    }
...
class FirstStage {
  ...
  FirstStage.fromJson(Map<String, dynamic> json) {
    thrustSeaLevel = json['thrust_sea_level'] != null ? new ThrustSeaLevel.fromJson(json['thrust_sea_level']) : null;
    thrustVacuum = json['thrust_vacuum'] != null ? new ThrustSeaLevel.fromJson(json['thrust_vacuum']) : null;
...
class SecondStage {
  ...
  SecondStage.fromJson(Map<String, dynamic> json) {
    thrust = json['thrust'] != null ? new ThrustSeaLevel.fromJson(json['thrust']) : null;
    payloads = json['payloads'] != null ? new Payloads.fromJson(json['payloads']) : null;
    reusable = json['reusable'];
    engines = json['engines'];
    fuelAmountTons = json['fuel_amount_tons'];
    burnTimeSec = json['burn_time_sec'];
...
class Payloads {
  ...
  Payloads.fromJson(Map<String, dynamic> json) {
    compositeFairing = json['composite_fairing'] != null ? new CompositeFairing.fromJson(json['composite_fairing']) : null;
